...
namespace Enter 
{
  public class Parallax : MonoBehaviour
  {
    ...
    private void Awake()
    {
      ...
      _material1 = new Material(_image1.material);
      _image1.material = _material1;
      _material2 = new Material(_image2.material);
      _image2.material = _material2;
    }
    ...
    void LateUpdate()
    {
      _image1.material.mainTextureOffset = new Vector2(Time.time, 0);
      Debug.Log(_image1.material.mainTextureOffset);
